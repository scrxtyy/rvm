    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" style="position:absolute!important;max-height:280px!important;overflow-y: auto!important;" aria-labelledby="dropdown01">
                <?php
              ...
              <a style ="
                ...
                if($i['type']=='storage'){
                    echo "RVM Storage is almost full.";
                }else if($i['type']=='coins'){
                    echo "COINS are almost empty.";
                }
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">RVM0001 Admin Dashboard</h4>
                </div>
                <div>
          ...
          <div class="row">
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Coins Amount (PHP)</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
